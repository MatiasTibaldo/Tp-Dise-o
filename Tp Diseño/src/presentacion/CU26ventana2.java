...
public class CU26ventana2 extends JFrame {
	...
	public CU26ventana2() {
			...
			JButton btnPreguntaSiguiente = new JButton("Pregunta siguiente");
			btnPreguntaSiguiente.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
				}
			});
			btnPreguntaSiguiente.setBounds(369, 267, 141, 35);
			contentPane.add(btnPreguntaSiguiente);
			
			JButton btnPreguntaAnterior = new JButton("Pregunta anterior");
			btnPreguntaAnterior.setBounds(51, 267, 141, 35);
			contentPane.add(btnPreguntaAnterior);
			...
			lblTiempoRestante.setBounds(235, 288, 106, 14);
			contentPane.add(lblTiempoRestante);
			
			JLabel lbltiempo = new JLabel("(tiempo)");
			lbltiempo.setBounds(257, 308, 65, 14);
